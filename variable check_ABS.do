...
rename readmrec =PQI
rename cftype =PQI
// no default set for this unlike with same variable in CF raw data
rename mstatus =PQI
rename resident =PQI
rename citizen =PQI
rename address =PQI
...
rename stiming =PQI
rename ctfeat =PQI
rename ctinfarct =PQI
rename ctsubhaem =PQI
rename ctinthaem =PQI
rename  =PQI
rename  =PQI
rename  =PQI
rename  =PQI
...
// ambcalldt hospdt atscndt frmscndt ecgdt reperfdt heplmwdt aspdt warfdt hepdt pladt o2dt gipdt insudt statdt noacsdt disdt dodtod


** Rename all HR-related variables to end in HR
rename absda =HR

Check for labels using variable manager
